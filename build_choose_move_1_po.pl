...
:-
    ...
    save_predicates(
        [
            ...
            maplist/5,
            best_opponent_move1/4,
            valid_moves_action1/3,
            list_create/3,
            valid_move_from_action1/3,
            best_N_moves/4,
            take/3,
            pairs_values/2,
            pairs_keys_values/3,
            expand_valid_moves_action1/3,
            expand_valid_move_action1/3,
            best_move/4,
            maplist_multi/7
        ],
        'obj/choose_move_1'
